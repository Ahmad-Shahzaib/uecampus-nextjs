    ...
    >
      ...
      <div className="relative z-10 space-y-6">
        ...
        >
          ...
          <span className="text-white inline-block text-purple-300">
            UeCampus?
          </span>
        </motion.h2>
        ...
        <p className="text-base lg:text-lg text-white/90 leading-relaxed max-w-lg">
          ...
          anywhere in the world, while gaining knowledge, skills, and confidence
          that empower you to thrive. At UeCampus, you don't just earn a degree
          – you gain the freedom, ambition, and competitive edge to shape the
          career and life you've always imagined.
        </p>
      </div>
