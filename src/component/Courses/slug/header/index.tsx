...
const CourseDetailHeader = () => {
  return (
    <div className="min-h-screen bg-[#999999] flex items-center justify-center p-4 sm:p-8 m-3 rounded-2xl lg:p-16">
      <div className="flex flex-col lg:flex-row w-full relative items-center lg:items-start">
        {/* Left section - title (gray card on mobile) */}
        <div className="w-full lg:flex-1 lg:pr-20 bg-gray-500 lg:bg-transparent rounded-2xl lg:rounded-none p-8 lg:p-0 shadow-lg lg:shadow-none">
          <h1 className="text-4xl sm:text-5xl lg:text-5xl font-semibold text-white leading-tight text-balance text-center lg:text-left">
            Level 7<br className="sm:hidden" /> Diploma<br className="lg:hidden" /> in<br className="lg:hidden" /> Health<br className="lg:hidden" /> and<br className="" /> Social<br className="lg:hidden" /> Care
          </h1>
        </div>
